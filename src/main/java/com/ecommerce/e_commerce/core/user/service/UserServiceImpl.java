...
import com.ecommerce.e_commerce.auth.auth.dto.CustomerRegistrationRequest;
import com.ecommerce.e_commerce.auth.auth.dto.LoginRequest;
import com.ecommerce.e_commerce.auth.auth.dto.RegisterRequest;
import com.ecommerce.e_commerce.auth.auth.dto.SellerRegistrationRequest;
...
import com.ecommerce.e_commerce.auth.auth.service.EmailVerificationService;
import com.ecommerce.e_commerce.auth.auth.service.JwtService;
...
public class UserServiceImpl implements UserService {
    ...
    @Override
    public boolean hasDefaultAddress(HttpServletRequest request) {
        User user = getUserByRequest(request);
        return user.hasCompleteShippingAddress();
    }
